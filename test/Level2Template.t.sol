...
contract ArraySortTest is Test {
    ...
    function testLevel2Template() public view {
        uint256[10] memory unsortedArray = [uint256(7), uint256(3), uint256(9), uint256(1), uint256(5), uint256(8), uint256(4), uint256(2), uint256(6), uint256(0)];
        uint256[10] memory expectedSortedArray = [uint256(0), uint256(1), uint256(2), uint256(3), uint256(4), uint256(5), uint256(6), uint256(7), uint256(8), uint256(9)];
